class Unassigned
{
    ...
    cacheDom()
    {
        this.$queryForm = $('#unassigned-search-form');
        this.$queryInput = $('#unassigned-search-term');
        this.$querySort = $('#unassigned-sort');
        this.$itemsWrapper = $('#unassigned-invoice-wrapper');
        this.$paginationWrapper = $('#unassigned-pagination-wrapper');
