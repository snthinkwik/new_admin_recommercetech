class ReadyForInvoice
{
    ...
    cacheDom()
    {
        this.$queryForm = $('#ready-for-invoice-search-form');
        this.$queryInput = $('#ready-for-invoice-filter-search-term');
        this.$querySort = $('#ready-for-invoice-sort');
        this.$itemsWrapper = $('#ready-for-invoice-wrapper');
        this.$paginationWrapper = $('#ready-for-invoice-pagination-wrapper');
