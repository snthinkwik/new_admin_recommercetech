class DpdInvoice
{
    ...
    cacheDom()
    {
        this.$queryForm = $('#dpd-search-form');
        this.$queryInput = $('#dpd-search-term');
        this.$querySort = $('#dpd-sort');
        this.$itemsWrapper = $('#dpd-list-table-wrapper');
        this.$paginationWrapper = $('#dpd-pagination-wrapper');
