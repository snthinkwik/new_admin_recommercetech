class eBayFeeManualAssigned
{
    ...
    cacheDom()
    {
        this.$queryForm = $('#manual-assigned-search-form');
        this.$queryInput = $('#manual-assigned-search-item');
        this.$querySort = $('#manual-assignment-sort');
        this.$itemsWrapper = $('#manual-assigned-items-wrapper');
        this.$paginationWrapper = $('#manual-assigned-pagination-wrapper');
