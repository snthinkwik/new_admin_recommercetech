...
@section('title', 'Back Market Update Logs - Details')

@section('content')

	<div class="container">

		<a class="btn btn-default" href="{{ route('back-market.update-logs') }}"><i class="fa fa-reply"></i> Back to List</a>

		<h2>Back Market Update Logs - Details</h2>
