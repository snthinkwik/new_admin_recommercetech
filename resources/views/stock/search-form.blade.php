...
<div class="form-group">
	<div class="input-group">
		<span class="input-group-addon">Unsold</span>
		<?php

			if(Request::input('unsold')){
				$unSold='Yes';
			}else{
				$unSold='No';
			}
		?>
		{!! BsForm::select('unsold',['Yes'=>'Yes','No'=>'No'] , $unSold,['id' => 'items-unsold']) !!}
	</div>
</div>


{{--		<input type="checkbox" value="1" name="unsold" id="items-unsold"  @if(Request::input('unsold')) checked @endif  checked> Unsold--}}
	...
	<div class="form-group">
        ...
        {!!
			...
			BsForm::select(
				'colour',
				['' => 'Any Colour'] + $colours = Colour::orderBy('pr_colour')->pluck('pr_colour', 'pr_colour')->toArray(),
