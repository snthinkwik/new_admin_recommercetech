...
{{--        {!! BsForm::close() !!}--}}
        ...
        @if(\Illuminate\Support\Facades\Session::get('quickbooks.oauth2.access_token'))
            OAuth2 AccessToken: {{ substr(\Illuminate\Support\Facades\Session::get('quickbooks.oauth2.access_token'), 0, 5).str_repeat('*', 20) }}<br/>
            OAuth2 AccessToken Expires At: {{ \Illuminate\Support\Facades\Session::get('quickbooks.oauth2.access_token_expires_at') }}<br/>
            OAuth2 RefreshToken: {{ substr(\Illuminate\Support\Facades\Session::get('quickbooks.oauth2.refresh_token'), 0, 5).str_repeat('*', 20) }}<br/>
            OAuth2 RefreshToken Expires At: {{ \Illuminate\Support\Facades\Session::get('quickbooks.oauth2.refresh_token_expires_at') }}<br/>
            OAuth2 RealmID: {{ \Illuminate\Support\Facades\Session::get('quickbooks.oauth2.realm_id') }}<br/>
        @endif
