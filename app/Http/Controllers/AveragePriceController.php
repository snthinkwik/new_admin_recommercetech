            ...
            if(count($finalData['data'])>0){
                foreach ($finalData['data'] as $price){
                    ...
                    $ebayData[]=[
                        ...
                        'average'=>money_format($average),
                        'best_price_from_named_seller'=> !empty($price['best_price_from_named_seller'])? money_format($price['best_price_from_named_seller']):'',
