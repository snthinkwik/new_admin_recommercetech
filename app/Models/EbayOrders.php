...
class EbayOrders extends Model
{
    ...
    {
        return $this->hasMany(EbayOrderItems::class, 'order_id', 'id');
    }

    public function Newsale()
    {
        return $this->hasOne(Sale::class, 'id', 'new_sale_id');
    ...
    {
        return $this->belongsToMany(EbayOrderItems::class, 'ebay_order_items', 'order_id', 'id');
    }
    ...
    {
        return \App\Models\EbayOrders::where('order_number', $orderNumber)->first();
    }
    ...
    {
        return $this->hasMany(DpdInvoice::class, 'parcel_number', 'tracking_number');
    }

    public function EbayDeliveryCharges()
    {
        return $this->hasOne( EbayDeliveryCharges::class , 'sales_record_number', 'sales_record_number');
    }

    public function ebayRefund()
    {
        return $this->hasOne( EbayRefund::class, 'order_id', 'id');
    }
